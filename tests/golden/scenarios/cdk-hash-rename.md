...
**Estimated monthly change: +$5.43**

| | |
|---|---:|
| Current estimate | $5.43 |
| Proposed estimate | $10.86 |
| Monthly change | +$5.43 |
| — fixed | +$5.43 |
| — usage-based | $0.00 |
...
|---|---|---:|---|
| stack/ProcessorInstance9F8E7D6C | InstanceHours | +$5.43 | LOW |
...
|---|---|---:|---:|---:|---|
| pull\-request\-cost\-increase | environment=development | $10.86 | — | — | estimate |
...
|---|---|---|---|
| expensive\-development\-change | not matched | — | applies=yes; monthly\_cost\_delta=$5\.43; threshold=$100\.00 |
...
| large\-low\-confidence\-change | not matched | — | applies=yes; monthly\_cost\_delta=$5\.43; threshold=LOW; confidence=LOW |
| budget:pull\-request\-cost\-increase:increase | not matched | — | estimated\_delta=$5\.43; maximum\_monthly\_increase=$100\.00 |
...
**ProcessorInstance9F8E7D6C runs continuously in development**

Currently costing: $10.86
