...
**Estimated monthly change: -$69.46**

| | |
|---|---:|
| Current estimate | $74.89 |
| Proposed estimate | $5.43 |
| Monthly change | -$69.46 |
| — fixed | -$69.46 |
| — usage-based | $0.00 |
| Unknown components | 0 |
| Confidence | MEDIUM |

<sub>0 added · 1 removed · 0 modified · 0 replaced · 1 unchanged</sub>
...
|---|---|---:|---|
| stack/ReportingDatabase | InstanceHours | -$46.46 | MEDIUM |
| stack/ReportingDatabase | Storage\-GB\-Month | -$23.00 | HIGH |
...
|---|---|---:|---:|---:|---|
| pull\-request\-cost\-increase | environment=development | $5.43 | — | — | estimate |
...
|---|---|---|---|
| expensive\-development\-change | not matched | — | applies=yes; monthly\_cost\_delta=$\-69\.46; threshold=$100\.00 |
...
| large\-low\-confidence\-change | not matched | — | applies=yes; monthly\_cost\_delta=$\-69\.46; threshold=LOW; confidence=MEDIUM |
| budget:pull\-request\-cost\-increase:increase | not matched | — | estimated\_delta=$\-69\.46; maximum\_monthly\_increase=$100\.00 |
...
| MultiAZ | false | BUILTIN_DEFAULT | CloudFormation defaults an unspecified deployment to Single\-AZ |
| monthly\_hours | 261 | CONFIG_ENVIRONMENT | 261 h/month derived from schedule 'Mon\-Fri 08:00\-20:00' using 730 h/month |
