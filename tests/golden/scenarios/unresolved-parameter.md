...
- `stack/Worker` `InstanceHours` — the instance type is not knowable before deployment: parameter 'WorkerInstanceType' has no supplied value and no default
...
|---|---|---|---|
| expensive\-development\-change | not matched | — | applies=yes; monthly\_cost\_delta=$0\.00; threshold=$100\.00 |
...
| large\-low\-confidence\-change | not matched | — | applies=yes; monthly\_cost\_delta=$0\.00; threshold=LOW; confidence=UNKNOWN |
| budget:pull\-request\-cost\-increase:increase | not matched | — | estimated\_delta=$0\.00; maximum\_monthly\_increase=$100\.00 |
...
**Worker runs continuously in development**

Currently costing: not established
